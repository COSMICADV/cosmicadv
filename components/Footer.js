  ...
  return (
    <footer className="bg-black text-white py-6">
      <div className="container mx-auto px-4 py-5">
        <div className="flex flex-col md:flex-row justify-center gap-72 items-start md:items-center w-full">
          ...
          <div className="mb-4 md:mb-0 flex flex-col ">
            ...
            <div className="flex flex-col mt-4">
              <ul className="py-2">
                ...
                <li className="my-2 text-lg">
                  <a
                    href="mailto:info@cosmicadv.com"
                    className="text-blue-400 hover:underline"
                  >
                    info@cosmicadv.com
                  </a>
          ...
          {/* Social Links */}
          <div className=" md:flex-row md:items-center mt-6 md:mt-0">
